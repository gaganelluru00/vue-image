<template>
     ...
     <div class="page-buttons ">
       <b-button id="prev"  :disabled="pageNumber<=1"   variant="info" @click="prev" sticky="true"><b>Previous</b></b-button>
       <b-button  variant="info" id="next"  @click="next"><b>Next</b></b-button>
    </div>

   <b-container center class="display">
      <span class="input"><b>Number Of Images </b><input type="number"   v-model.number="limit" /></span>
   </b-container>
